...
class Message {
	...
	public function getMessages($otherUser) {
		...
		while($row = mysqli_fetch_array($get_messages_query)) {
			...
			// var_dump($user_to . " " . $userLoggedIn);

			$div_top = (strtolower($user_to) == strtolower($userLoggedIn)) ? "<div class='message' id='green'>" : "<div class='message' id='blue'>";
	...
	public function getConvos() {
		...
		foreach($convos as $username) {
			...
			$return_string .= "<a href='messages.php?u=$username'> <div class='user_found_messages'>
								<img src='" . $user_found_obj->getProfilePic() . "' style='border-radius: 5px; margin-right: 5px;'> <br>
